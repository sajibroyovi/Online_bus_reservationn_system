	...
	$row=mysqli_num_rows($run);
		...
		{	for($i=1;$i<=$row;$i++){		
			...
			if($data['userid']==$id)
			{
				...
				<button style="width:120px;height:40px;margin-top:5px;background-color:#1168f2;"><a href="canclefrom.php?id=<?php echo $data['id'];?>" style="text-decoration:none;padding:8px 10px;font-size:18px;">Cancel</a></button>
				</div>
				<?php
			}
